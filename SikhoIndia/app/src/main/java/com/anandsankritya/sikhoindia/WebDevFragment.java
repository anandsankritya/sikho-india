...
public class WebDevFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("Web Development");


        View view = inflater.inflate(R.layout.fragment_web_dev, container, false);
        ...
        Query query = reference.orderByChild("category").equalTo("Web Dev");
